"""
ACE Load Test Fixtures

Pytest fixtures for ACE load tests.
...
@pytest_asyncio.fixture(scope="function")
async def get_session(test_db_engine):
    """
    ...
    def _get_session():
        """Return async context manager for session."""
...
async def setup_database(test_db_engine):
    """Initialize database for ACE load tests.
