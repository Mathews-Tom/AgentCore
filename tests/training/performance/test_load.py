...
class TestLoadPerformance:
    ...
    async def test_api_response_time(self) -> None:
        ...
        from agentcore.training.services.training_jsonrpc import get_training_status
...
class TestScalabilityPerformance:
    ...
    async def test_concurrent_api_requests(self) -> None:
        ...
        from agentcore.training.services.training_jsonrpc import start_training_job
