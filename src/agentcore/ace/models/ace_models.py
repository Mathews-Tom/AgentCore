...
Data models for:
- Context evolution and performance monitoring
- Capability evaluation, fitness scoring, and recommendations
- Strategic interventions and outcome tracking
- Self-supervised context improvement for long-running agents

Follows COMPASS ACE specifications (ACE-1 through ACE-4).
"""
...
# Capability Evaluation Models (COMPASS ACE-4)
