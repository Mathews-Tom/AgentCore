...
Revision ID: d1509698cef3
Revises: 068b96d43e02
Create Date: 2025-10-14 02:59:24.383752
...
def upgrade() -> None:
    ...
    op.create_table('agent_public_keys',
    ...
    sa.Column('capability_embedding', sa.JSON(), nullable=True),  # TODO: Use Vector(384) when pgvector is available
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('state', sa.Enum('ACTIVE', 'PAUSED', 'SUSPENDED', 'COMPLETED', 'FAILED', 'EXPIRED', name='sessionstate'), nullable=False),
    sa.Column('priority', sa.Enum('LOW', 'NORMAL', 'HIGH', 'CRITICAL', name='sessionpriority'), nullable=False),
    sa.Column('owner_agent', sa.String(length=255), nullable=False),
    sa.Column('participant_agents', sa.JSON(), nullable=False),
    ...
    sa.Column('max_idle_seconds', sa.Integer(), nullable=False),
    ...
    op.create_index('idx_session_expires_at', 'session_snapshots', ['expires_at'], unique=False)
    op.create_index('idx_session_owner', 'session_snapshots', ['owner_agent'], unique=False)
    op.create_index('idx_session_state', 'session_snapshots', ['state'], unique=False)
    ...
    op.create_index(op.f('ix_session_snapshots_expires_at'), 'session_snapshots', ['expires_at'], unique=False)
    op.create_index(op.f('ix_session_snapshots_owner_agent'), 'session_snapshots', ['owner_agent'], unique=False)
    op.create_index(op.f('ix_session_snapshots_session_id'), 'session_snapshots', ['session_id'], unique=False)
    op.create_index(op.f('ix_session_snapshots_state'), 'session_snapshots', ['state'], unique=False)
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'ASSIGNED', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', 'TIMEOUT', name='taskstatus'), nullable=False),
    sa.Column('priority', sa.Integer(), nullable=False),
    sa.Column('required_capabilities', sa.JSON(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_session_snapshots_state'), table_name='session_snapshots')
    op.drop_index(op.f('ix_session_snapshots_session_id'), table_name='session_snapshots')
    op.drop_index(op.f('ix_session_snapshots_owner_agent'), table_name='session_snapshots')
    op.drop_index(op.f('ix_session_snapshots_expires_at'), table_name='session_snapshots')
